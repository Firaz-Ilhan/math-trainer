...
public class AppTest {
    ...
    /* -- OrderOfOperation -- */
    @Test public void test_oderofoperation_beginner() {
    ...
    @Test public void test_oderofoperation_medium() {
        Arithmetic order = new OrderOfOperation("medium");
        int result = order.getSolution(order.getTask());
        Assert.assertTrue( result >= 132 && result <= 240) ;
    }

    @Test public void test_oderofoperation_hard() {
